...
const TAB_CONTENT = {
  ...
  projects:  { icon: "💻", title: "Dự án của mình",        desc: "Lười làm chó gì có dự án." },
  hobbies:   { icon: "❤️", title: "Sở thích & Niềm đam mê", desc: "Những điều mình yêu thích: gaming, âm nhạc và cậu." },
